...
<!-- $this->include('merchant/add_merchant_form') data-toggle="modal" data-target="#addMerchantModal"  -->
<div class="container box">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-header">
                <h2>Manage Merchant
                    <a href="<?= base_url('add_merchant'); ?>" role="button" class="btn btn-outline-dark float-right">
                        Add Merchant
                    </a>
                </h2>
            </div>
